...
namespace Microsoft.CodeAnalysis.CSharp.Syntax.InternalSyntax
{
    ...
    internal class DocumentationCommentParser2 : SyntaxParser2
    {
        private readonly SyntaxListPool _pool = new SyntaxListPool();
        private bool _isDelimited;

        internal DocumentationCommentParser2(Lexer2 lexer, LexerMode modeflags)
        ...
        private SkipResult SkipBadTokens<T>(
            ...
            Func<DocumentationCommentParser2, bool> isNotExpectedFunction,
            Func<DocumentationCommentParser2, bool> abortFunction,
