...
{
    internal partial class Lexer2 : AbstractLexer
    {
        ...
        private DocumentationCommentParser2 _xmlParser;
        ...
        public Lexer2(SourceText text, CSharpParseOptions options, bool allowPreprocessorDirectives = true, bool interpolationFollowedByColon = false)
            : base(text)
        {
...
top:
            ...
            ref SyntaxListBuilder triviaList)
        {
            ...
            using (var dp = new DirectiveParser2(this, _directives))
            {
        ...
        private CSharpSyntaxNode LexXmlDocComment(XmlDocCommentStyle style)
        {
            ...
            if (_xmlParser == null)
            {
                _xmlParser = new DocumentationCommentParser2(this, mode);
            }
            else
            {
