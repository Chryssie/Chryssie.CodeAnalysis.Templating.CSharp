...
namespace Microsoft.CodeAnalysis.CSharp.Syntax.InternalSyntax
{
    ...
    internal abstract partial class SyntaxParser2 : IDisposable
    {
        protected readonly Lexer2 lexer;
        private readonly bool _isIncremental;
        private readonly bool _allowModeReset;
        protected readonly CancellationToken cancellationToken;

        private LexerMode _mode;
        private Blender2 _firstBlender;
        private BlendedNode2 _currentNode;
        ...
        private static readonly ObjectPool<BlendedNode2[]> s_blendedNodesPool = new ObjectPool<BlendedNode2[]>(() => new BlendedNode2[32], 2);

        private BlendedNode2[] _blendedTokens;

        protected SyntaxParser2(
            Lexer2 lexer,
            LexerMode mode,
            ...
            CancellationToken cancellationToken = default(CancellationToken))
        {
            ...
            _currentNode = default(BlendedNode2);
            _isIncremental = oldTree != null;

            if (this.IsIncremental || allowModeReset)
            {
                _firstBlender = new Blender2(lexer, oldTree, changes);
                _blendedTokens = s_blendedNodesPool.Allocate();
            }
            else
            {
                _firstBlender = default(Blender2);
        ...
        protected void ReInitialize()
        {
            ...
            {
                _firstBlender = new Blender2(this.lexer, null, null);
            }
        }
        ...
        private void AddToken(in BlendedNode2 tokenResult)
        {
