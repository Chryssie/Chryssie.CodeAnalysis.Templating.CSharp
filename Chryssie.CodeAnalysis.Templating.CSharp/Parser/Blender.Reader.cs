...
{
    internal partial struct Blender2
    {
        private struct Reader
        {
            ...
            public Reader(Blender2 blender)
            {
            ...
            internal BlendedNode2 ReadNodeOrToken(LexerMode mode, bool asToken)
            {
            ...
            private BlendedNode2 ReadNewToken(LexerMode mode)
            {
                ...
                out BlendedNode2 blendedNode)
            {
                ...
                {
                    blendedNode = default(BlendedNode2);
                    return false;
                }
            ...
            private BlendedNode2 CreateBlendedNode(CSharp.CSharpSyntaxNode node, SyntaxToken token)
            {
                return new BlendedNode2(node, token,
                    new Blender2(_lexer, _oldTreeCursor, _changes, _newPosition, _changeDelta, _newDirectives, _oldDirectives, _newLexerDrivenMode));
            }
        }
    }
}
