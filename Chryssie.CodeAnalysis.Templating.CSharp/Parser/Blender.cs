...
{
    internal readonly partial struct Blender2
    {
        ...
        public Blender2(Lexer2 lexer, CSharp.CSharpSyntaxNode oldTree, IEnumerable<TextChangeRange> changes)
        {
        ...
        public BlendedNode2 ReadNode(LexerMode mode)
        {
            return ReadNodeOrToken(mode, asToken: false);
        }

        public BlendedNode2 ReadToken(LexerMode mode)
        {
            return ReadNodeOrToken(mode, asToken: true);
        }

        private BlendedNode2 ReadNodeOrToken(LexerMode mode, bool asToken)
        {
